...
mediagalleryCommand.Execute=function() {
    ...
    window.open(FCKPlugins.Items['mediagallery'].Path + 'mediagallery.php?i=' + FCK.Name, 'mediagallery', 'width=650,height=650,resizable=yes,scrollbars=yes,scrolling=yes,location=no,toolbar=no');
}
