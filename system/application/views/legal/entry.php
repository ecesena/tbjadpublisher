...
<div id="topButtons">
    ...
    <div class="entryButton left" style""><a href="#new" onclick="newAd();">New Entry</a></div>
    <div class="entryButton right" style""><a href="#delete" onclick="delEntry();">Delete Entry</a></div>
    <div class="entryButton left" style=""><a href="#copy" onclick="copyAd();">Copy Ad</a></div>
    <div class="entryButton right" style=""><a href="#reload" onclick="window.location.reload();">Trim Spaces</a></div>
    <div class="entryButton center" style=""><a href="#reload" onclick="cleanup();">Recalculate Ad Size</a></div>
