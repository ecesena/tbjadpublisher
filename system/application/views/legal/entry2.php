...
<script src="<?=$this->config->item('base_url')?>javascript/jquery.js" type="text/javascript"></script>
<script src="<?=$this->config->item('base_url')?>javascript/tinymce/tinymce.min.js" type="text/javascript"></script>
<script>
