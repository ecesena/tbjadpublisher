...
<?php
	...
	/*require_once '/system/application/helpers/rtfgenPHPRtfLite.php';
	...
	$main_text = preg_replace('#\r?\n#', '\\r\\n',(addslashes($ad_info->adtext)));
	$pattern = "/<p[^>]*><\\/p[^>]*>/";

	$final_text = preg_replace($pattern, '', $main_text);
	// output
